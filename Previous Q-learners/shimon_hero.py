...
class GameSettings(object):
    def __init__(self):
        ...
        self.NOTE_HEIGHT = self.NOTE_WIDTH * 2
        ...
        self.ACCELERATION = 10.  # if acceleration is < 0 use instant velocity - specified in pixels/frame/frame
        ...
        self.ARM_COLLISION_PENALTY = -0.1  # punishment for arms colliding
...
class Game(object):
    ...
    def next_action(self, input_actions):
        ...
        if gs.CONTROL_MODE == "list_enumerated":
            ...
            if input_actions[0] == 1:  # do nothing (00) i.e all keys up
                ...
                self.arm_actions[0] = -1
                self.arm_actions[1] = -1
        elif gs.CONTROL_MODE == "direct": # control arms directly - bypassing arm direction
