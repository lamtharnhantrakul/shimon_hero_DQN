...
class GameSettings(object):
    def __init__(self):
        ...
        self.ARM_STARTS[1] = random.uniform(0.1,1) * self.SCREEN_WIDTH

        self.GAME_TITLE = 'shimon_hero_DQN_LSTM'
        self.TPS = 100
    ...
    def next_action(self, input_actions):
        ...
        if self.note_count < len(self.midi_notes) - 1:
            while self.midi_notes[self.note_count][1] == self.step_count:
                ...
                print ("self.note_list:", self.note_list)
        ...
        # If the agent moves, it incurs a small cost
        ...
        return image_data, self.reward, self.is_terminal, score_total, note_vector
