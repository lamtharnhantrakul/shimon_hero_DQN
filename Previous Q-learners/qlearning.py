...
FRAME_PER_ACTION = 10 # This controls how many frames to wait before deciding on an action. If F_P_A = 1, then Shimon
...
# TODO: IMPLEMENT A "WATCH NETWORK PLAY THE GAME" MODE
def playGameWithNetwork():
    pass
