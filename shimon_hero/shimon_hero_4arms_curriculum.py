    ...
    def __init__(self):
        ...
        for i in range(self.NUMBER_OF_ARMS):  # initialize arm stuff
            if i % 2 == 0:  # arm is on left
                ...
                right_arms += 1
        '''
        self.ARM_DIRECTION[0] = 1
        self.ARM_DIRECTION[1] = 1
        self.ARM_DIRECTION[2] = 1
        self.ARM_DIRECTION[3] = 1

        self.ARM_STARTS[0] = 0.10 * self.SCREEN_WIDTH
        self.ARM_STARTS[1] = 0.33 * self.SCREEN_WIDTH
        self.ARM_STARTS[2] = 0.66 * self.SCREEN_WIDTH
        self.ARM_STARTS[3] = 0.90 * self.SCREEN_WIDTH
...
class Game(object):
    ...
    def next_action(self, input_actions):
        ...
        if penalty_hits:
            ...
            self.reward = -1  # If Shimon misses a note, give negative reward
            self.is_terminal = True  # If Shimon misses a note, restart the game
