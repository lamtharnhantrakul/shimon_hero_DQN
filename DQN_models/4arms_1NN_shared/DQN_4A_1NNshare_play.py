...
def playGame(model, game):
    ...
    while (True):
        ...
        # run the selected action and observed next state and r_t
            image_data, r_t, game_over, game_score = game.next_action(
                [action_dict[arm0_act_idx], action_dict[arm1_act_idx], action_dict[arm2_act_idx],
                 action_dict[arm3_act_idx]])
        ...
        debugging_string = "TIME %8d | 0_ACT %3d | 1_ACT %3d | 2_ACT %3d | 3_ACT %3d |MAX_SCORE %3d" % (t, action_dict[arm0_act_idx],action_dict[arm1_act_idx],action_dict[arm2_act_idx],action_dict[arm3_act_idx],max_score)
